...
# stable diffusion v2-1を使用する
from PIL import Image
import webuiapi
api = webuiapi.WebUIApi()
options = {}
options['sd_model_checkpoint'] = 'v2-1_768-ema-pruned.ckpt [ad2a33c361]'
...
result1.image.save("test_9_1.png")
result1.images[1].save("test_9_2.png")
print(result1.image)
